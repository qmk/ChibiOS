...
/**
 * @file    ARMCRx/compilers/GCC/crt1.c
 * @brief   Startup stub functions.
 *
 * @addtogroup ARMCRx_GCC_STARTUP
 * @{
 */
...
#if (CRT0_EXTRA_CORES_NUMBER < 0) || (CRT0_EXTRA_CORES_NUMBER > 1)
#error "CRT0_EXTRA_CORES_NUMBER must be within 0 and 1"
#endif
